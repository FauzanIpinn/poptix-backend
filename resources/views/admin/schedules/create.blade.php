    ...
    <form action="{{ route('admin.schedules.store') }}" method="POST" class="bg-ticketor-card p-6 rounded-xl border border-gray-800 space-y-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="date" name="show_date" id="show_date" value="{{ old('show_date') }}" required class="w-full bg-ticketor-dark border border-gray-800 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-ticketor-neon transition">
            ...
            <div>
                ...
                <input type="time" name="show_time" id="show_time" value="{{ old('show_time') }}" required class="w-full bg-ticketor-dark border border-gray-800 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-ticketor-neon transition">
        ...
        <div>
            ...
            <input type="number" name="price" id="price" value="{{ old('price', 50000) }}" required min="0" step="1000" class="w-full bg-ticketor-dark border border-gray-800 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-ticketor-neon transition">
