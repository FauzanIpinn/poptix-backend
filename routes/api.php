...
| API v1
|--------------------------------------------------------------------------
| Semua endpoint di-versioning di bawah /api/v1/*. Kalau nanti ada breaking
| change (ubah shape response, hapus field, dst), buat routes/api_v2.php
| baru dan daftarkan sebagai grup /v2 terpisah -- JANGAN ubah v1 secara
| breaking, supaya klien lama (mobile app, dsb) tidak langsung rusak.
*/
